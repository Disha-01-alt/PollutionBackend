...
# EcoMonitor Backend API Server Startup Script
...
echo "=== EcoMonitor Backend API Server ==="
...
echo ""
echo "Starting pure API server with real pollution data..."
...
echo ""
echo "This is a pure API server with no frontend components."
echo "The frontend must be started separately using run_frontend.sh"
echo ""
